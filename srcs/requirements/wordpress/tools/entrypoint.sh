...
then
    ...
    wp core install --allow-root --url="https://chsiffre.42.fr" --title="MY inception site" --admin_name="${WP_USERNAME_ADMIN}" --admin_password="${WP_ADMIN_PASSWORD}" --admin_email="${WP_ADMIN_MAIL}" --skip-email
